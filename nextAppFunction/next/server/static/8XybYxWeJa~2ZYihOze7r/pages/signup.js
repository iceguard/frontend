...
function (_Component) {
  ...
  function SignUp() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "passwordValuesDoMatch", function () {
      var _this$state$form = _this.state.form,
          password = _this$state$form.password,
          passwordRepeat = _this$state$form.passwordRepeat;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (event) {
      ...
      if (!_this.passwordValuesDoMatch()) {
      ...
      app_default.a.auth().createUserWithEmailAndPassword(form.email.value, form.password.value).then(function () {
        _this.setState({
          signUpSuccess: true
        });
  ...
  _createClass(SignUp, [{
    ...
    value: function render() {
      ...
      var signUpSuccess = this.state.signUpSuccess;
      return signUpSuccess ? external_react_default.a.createElement("p", null, "Registration successful") : external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("h2", null, "Sign Up"), external_react_default.a.createElement(_core_form["a" /* Form */], {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return signup_SignUpPage; });
function signup_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { signup_typeof = function _typeof(obj) { return typeof obj; }; } else { signup_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return signup_typeof(obj); }
...
function signup_createClass(Constructor, protoProps, staticProps) { if (protoProps) signup_defineProperties(Constructor.prototype, protoProps); if (staticProps) signup_defineProperties(Constructor, staticProps); return Constructor; }

function signup_possibleConstructorReturn(self, call) { if (call && (signup_typeof(call) === "object" || typeof call === "function")) { return call; } return signup_assertThisInitialized(self); }
...
function signup_getPrototypeOf(o) { signup_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return signup_getPrototypeOf(o); }

function signup_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) signup_setPrototypeOf(subClass, superClass); }

function signup_setPrototypeOf(o, p) { signup_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return signup_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_Component) {
  signup_inherits(SignUpPage, _Component);

  function SignUpPage() {
    signup_classCallCheck(this, SignUpPage);

    return signup_possibleConstructorReturn(this, signup_getPrototypeOf(SignUpPage).apply(this, arguments));
  }

  signup_createClass(SignUpPage, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Main["a" /* default */], null, external_react_default.a.createElement(SignUp_SignUp, null));
    }
  }]);
