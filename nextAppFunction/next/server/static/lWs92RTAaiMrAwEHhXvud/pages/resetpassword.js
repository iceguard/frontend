...
// CONCATENATED MODULE: ./components/@auth/ResetPassword.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  function ResetPassword() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResetPassword).call(this));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (event) {
      ...
      var emailValue = _this.state.form.email.value;
      app_default.a.auth().sendPasswordResetEmail(emailValue).then(function () {
        _this.setState({
  ...
  _createClass(ResetPassword, [{
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          passwordResetLinkSent = _this$state.passwordResetLinkSent;

      if (passwordResetLinkSent) {
        return external_react_default.a.createElement("p", null, "Wir haben Ihnen ein E-Mail an ", external_react_default.a.createElement("strong", null, form.email.value), " gesendet.");
      }

      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("h2", null, "Reset password"), external_react_default.a.createElement(_core_form["a" /* Form */], {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return resetpassword_ResetPasswordPage; });
function resetpassword_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { resetpassword_typeof = function _typeof(obj) { return typeof obj; }; } else { resetpassword_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return resetpassword_typeof(obj); }

function resetpassword_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function resetpassword_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function resetpassword_createClass(Constructor, protoProps, staticProps) { if (protoProps) resetpassword_defineProperties(Constructor.prototype, protoProps); if (staticProps) resetpassword_defineProperties(Constructor, staticProps); return Constructor; }

function resetpassword_possibleConstructorReturn(self, call) { if (call && (resetpassword_typeof(call) === "object" || typeof call === "function")) { return call; } return resetpassword_assertThisInitialized(self); }

function resetpassword_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function resetpassword_getPrototypeOf(o) { resetpassword_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return resetpassword_getPrototypeOf(o); }

function resetpassword_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) resetpassword_setPrototypeOf(subClass, superClass); }

function resetpassword_setPrototypeOf(o, p) { resetpassword_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return resetpassword_setPrototypeOf(o, p); }





var resetpassword_ResetPasswordPage =
/*#__PURE__*/
function (_Component) {
  resetpassword_inherits(ResetPasswordPage, _Component);

  function ResetPasswordPage() {
    resetpassword_classCallCheck(this, ResetPasswordPage);

    return resetpassword_possibleConstructorReturn(this, resetpassword_getPrototypeOf(ResetPasswordPage).apply(this, arguments));
  }

  resetpassword_createClass(ResetPasswordPage, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Main["a" /* default */], null, external_react_default.a.createElement(ResetPassword_ResetPassword, null));
    }
  }]);
